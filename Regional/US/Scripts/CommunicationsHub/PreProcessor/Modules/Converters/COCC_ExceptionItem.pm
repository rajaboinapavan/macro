package Converters::COCC_ExceptionItem;
...
# Module Globals
#
my $DOCUMENT_TYPE   = q(ExceptionItem);      # used for output JSON file postfix
my $FILENAME_SUFFIX = q(CK_NSFNT_NOTICE);    # used for input XML file postfix
...
sub handle_document_details {
	...
	$doc_details->{'TEMPLATE'}      = 'NOTICE OF EXCEPTION ITEMS';
